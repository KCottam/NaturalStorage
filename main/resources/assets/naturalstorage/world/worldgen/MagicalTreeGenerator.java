...
public class MagicalTreeGenerator extends BaseTreeGenerator
{
    private Random rand;
    ...
    public MagicalTreeGenerator(IBlockState bark, IBlockState heart, IBlockState core, IBlockState root, IBlockState leaves, boolean useHeight, boolean isSapling)
    {
        this.bark = bark;
        this.heart = heart;
        this.core = core;
    ...
    public MagicalTreeGenerator(IBlockState log, IBlockState heart, IBlockState core, IBlockState root, IBlockState leaves)
    {
        this(log, heart, core, root, leaves, true, true);
    }
    ...
    BlockPos findGround(World world, BlockPos pos)
    {
        if (world.getWorldType() == WorldType.FLAT && this.isSapling)
        {
            ...
            do
            {
                ...
                if (underBlock == Blocks.DIRT || underBlock == Blocks.GRASS || height < 64)
                {
                    foundGround = true;
                }
            }
    ...
    public boolean genRing9(World world, Random random, BlockPos pos)
    {
        if (world.getBlockState(pos).getBlock() != Blocks.BEDROCK && pos.getY() > 0)
        {
            ...
            this.setBlockAndMetadata(world, pos, this.core);
